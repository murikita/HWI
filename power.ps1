...
$smtp.Credentials = New-Object System.Net.NetworkCredential("abdulkasi18@outlook.com", "0992964337Miracle");
$smtp.EnableSsl = $true
$Message.From = "abdulkasi18@outlook.com"
$Message.To.Add("abdulkasi18@gmail.com")
